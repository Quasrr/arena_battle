...
<section class="leaderboard">
    <div class="leaderboard-hero">
        <div class="leaderboard-text">
            <p class="leaderboard-eyebrow">Classement</p>
            <h1>Page en construction</h1>
            <p class="leaderboard-subtitle">
                Le classement arrive bientôt. Revenez pour découvrir ceux qui dominent
                le haut du tableau.
            </p>
        </div>
        <div class="leaderboard-visual">
            <img src="/images/characters3.png" alt="Classement en construction" />
        </div>
    </div>
</section>
